          ...
          <AnimatePresence mode="wait">
            {isSuccess ? (
              ...
              <motion.div key="signin" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0, scale: 0.97, transition: { duration: 0.2 } }}>
                ...
                <h2 className="mb-1.5 text-[24px] font-semibold tracking-[-0.03em] text-foreground sm:text-[28px]" style={{ fontFamily: "var(--font-display)" }}>Welcome to HawkLife.</h2>
                <p className="mb-6 max-w-[290px] text-sm leading-6 text-muted-foreground sm:mb-8">Sign in with your St. Joseph&apos;s Preparatory School Google account.</p>
                <div className="auth-divider mb-6 h-px sm:mb-8" />
