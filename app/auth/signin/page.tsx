    ...
    <div className="auth-page-bg min-h-screen flex items-center justify-center px-4 py-6 sm:p-6">
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          {error && (
            <p className="mt-6 text-center text-[12px] leading-5 text-[hsl(var(--primary))]">
              {error === "DomainNotAllowed"
                ? "Only school accounts are allowed."
          ...
          >
            <svg viewBox="0 0 24 24" style={{ height: 18, width: 18, flexShrink: 0 }}>
